  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray'>              <p>Welcome To Prescripto, Your Trusted Partner In Managing
            At Prescripto, We Understand The Challenges Individuals Face
            ...
            <b>Our Vision</b>
            <p>Our Vision At Prescripto Is To Create A Seamless Healthcare Experience For Every User. We Aim To Bridge The
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border px-10 md:px-16 pt-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white cursor-pointer transition-all duration-300'>
          <b>Efficiency:</b>
